...
namespace LSL
{
    ...
    */
    public class StreamInlet : LSLObject
    {
        ...
        */
        public double pull_sample(float[] sample, double timeout = LSL.FOREVER) 
        { 
        ...
        public double pull_sample(double[] sample, double timeout = LSL.FOREVER) { Console.Write("2"); int ec = 0; double res = dll.lsl_pull_sample_d(obj, sample, sample.Length, timeout, ref ec); LSL.check_error(ec); return res; }
        public double pull_sample(int[] sample, double timeout = LSL.FOREVER) { Console.Write("3"); int ec = 0; double res = dll.lsl_pull_sample_i(obj, sample, sample.Length, timeout, ref ec); LSL.check_error(ec); return res; }
        public double pull_sample(short[] sample, double timeout = LSL.FOREVER) { Console.Write("4"); int ec = 0; double res = dll.lsl_pull_sample_s(obj, sample, sample.Length, timeout, ref ec); LSL.check_error(ec); return res; }
        public double pull_sample(char[] sample, double timeout = LSL.FOREVER) { Console.Write("5"); int ec = 0; double res = dll.lsl_pull_sample_c(obj, sample, sample.Length, timeout, ref ec); LSL.check_error(ec); return res; }
